<template>
  <div id="home">
    <van-swipe :autoplay="3000" indicator-color="white">
      ...
      <van-swipe-item>
        <img src="../assets/jvascript.jpg" alt />
      </van-swipe-item>
      <van-swipe-item>
        <img src="../assets/vue.jpg" alt />
      </van-swipe-item>
      <van-swipe-item>
        <img src="../assets/nodejs.jpg" alt />
      </van-swipe-item>
    </van-swipe>
    <div style="background:#fafafa" class="article" v-for="(item,index) in allArticles" :key="index">
